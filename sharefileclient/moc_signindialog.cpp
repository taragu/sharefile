...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SignInDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 39, 0)
    ...
    "SignInDialog\0on_signin_submit_accepted\0"
    "\0"
};
...
void SignInDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_signin_submit_accepted(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject SignInDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SignInDialog.data,
      qt_meta_data_SignInDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SignInDialog.stringdata))
        return static_cast<void*>(const_cast< SignInDialog*>(this));
    if (!strcmp(_clname, "MessageSubject"))
        return static_cast< MessageSubject*>(const_cast< SignInDialog*>(this));
