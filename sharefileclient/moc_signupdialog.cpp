...
QT_MOC_LITERAL(6, 74, 10)
    ...
    "SignUpDialog\0on_signup_submit_accepted\0"
    "\0changeMessage\0std::string\0message\0"
    "getMessage\0"
};
...
void SignUpDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_signup_submit_accepted(); break;
        case 1: _t->changeMessage((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 2: { std::string _r = _t->getMessage();
...
void *SignUpDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "MessageSubject"))
        return static_cast< MessageSubject*>(const_cast< SignUpDialog*>(this));
